...
--[[
  ...
  -Ensure that you have the junglenational_attachments.xml, junglenational_attachments.js, and junglenational_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that junglenational_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/junglenational_attachments.xml" />
