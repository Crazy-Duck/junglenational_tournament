...
--[[
  ...
  -Ensure that you have the junglenational_notifications.xml, junglenational_notifications.js, and junglenational_notifications.css files in your panorama content folder.
  -Ensure that junglenational_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/junglenational_notifications.xml" />
